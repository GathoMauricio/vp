        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="ciudad" value="{{ old('ciudad',$user->ciudad) }}" id="txt_ciudad_sepomex" type="text"
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="municipio" value="{{ old('municipio',$user->municipio) }}" id="txt_municipio_sepomex"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="estado" value="{{ old('estado',$user->estado) }}" id="txt_estado_estado" type="text"
                        class="form-control" readonly>
