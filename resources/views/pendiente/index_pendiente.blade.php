...
<div class="container">
    ...
    <div class="row shadow p-3  bg-white rounded">
        <h4>Lista de servicios pendientes</h4>
    </div>
    <div class="row shadow p-3  bg-white rounded">
        {{ $services->links() }}
        ...
        @foreach($services as $service)
            <tr>
                ...
                <td>{{ $service->manager['name'] }} {{ $service->manager['last_name1'] }} {{ $service->manager['last_name2'] }}</td>
                <td>{{ $service->technical['name'] }} {{ $service->technical['last_name1'] }} {{ $service->technical['last_name2'] }}</td>
                <td>{{ $service->customer['name'] }}</td>
                <td>{{ $service->usuario_Final['name'] }} {{ $service->usuario_Final['last_name1'] }} {{ $service->usuario_Final['last_name2'] }}</td>
